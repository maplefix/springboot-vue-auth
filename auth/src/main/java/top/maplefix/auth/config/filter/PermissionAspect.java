...
import top.maplefix.auth.config.annotation.Logical;
import top.maplefix.auth.config.annotation.RequiresPermissions;
import top.maplefix.auth.config.exception.UnauthorizedException;
...
public class PermissionAspect {
    ...
    @Before("@annotation(top.maplefix.auth.config.annotation.RequiresPermissions)")
